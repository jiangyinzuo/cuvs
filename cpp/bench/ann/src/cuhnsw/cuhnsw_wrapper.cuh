 ...
 public:
  ...
  benchmark::UserCounters get_custom_counters() const override
  {
    ...
    if constexpr (cuvs::bench::collect_metrics) {
      ...
      counters["metrics_distance_computation_counter_upper_layers"] =
        statistics.distance_computation_counter_upper_layers;
      ...
      counters["metrics_counter_set_candidates_checked"] =
        statistics.counter_set_candidates_checked;
...
void cuhnsw_impl::set_search_param(const search_param_base& param, const void* filter_bitset)
{
