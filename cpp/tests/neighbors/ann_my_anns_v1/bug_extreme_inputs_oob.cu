...
class my_anns_v1_extreme_inputs_oob_test : public ::testing::Test {
 public:
 ...
 protected:
  void run()
  {
    ...
    try {
      [[maybe_unused]] auto ix = my_anns_v1::build(res, ix_ps, raft::make_const_mdspan(dataset->view()));
...
TEST_F(my_anns_v1_extreme_inputs_oob_test, my_anns_v1_extreme_inputs_oob_test) { this->run(); }
