...
TEST(my_anns_v1C, BuildSearch)
{
  ...
  cuvsmy_anns_v1IndexCreate(&index);

  // build index
  cuvsmy_anns_v1IndexParams_t build_params;
  cuvsmy_anns_v1IndexParamsCreate(&build_params);
  cuvsmy_anns_v1Build(res, build_params, &dataset_tensor, index);
  ...
  // search index
  cuvsmy_anns_v1SearchParams_t search_params;
  cuvsmy_anns_v1SearchParamsCreate(&search_params);
  cuvsmy_anns_v1Search(
  ...
  cuvsmy_anns_v1SearchParamsDestroy(search_params);
  cuvsmy_anns_v1IndexParamsDestroy(build_params);
  cuvsmy_anns_v1IndexDestroy(index);
  cuvsResourcesDestroy(res);
}

TEST(my_anns_v1C, BuildExtendSearch)
{
  // create cuvsResources_t
  cuvsResources_t res;
  cuvsResourcesCreate(&res);
  ...
  // extend index
  cuvsmy_anns_v1ExtendParams_t extend_params;
  cuvsmy_anns_v1ExtendParamsCreate(&extend_params);
  cuvsmy_anns_v1Extend(
  ...
  // de-allocate index and res
  cuvsmy_anns_v1SearchParamsDestroy(search_params);
  cuvsmy_anns_v1ExtendParamsDestroy(extend_params);
  cuvsmy_anns_v1IndexParamsDestroy(build_params);
  cuvsmy_anns_v1IndexDestroy(index);
  cuvsResourcesDestroy(res);
}

TEST(my_anns_v1C, BuildSearchFiltered)
{
  // create cuvsResources_t
  cuvsResources_t res;
  cuvsResourcesCreate(&res);
