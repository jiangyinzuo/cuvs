...
template <typename T>
void* _build(cuvsResources_t res, cuvsmy_anns_v1IndexParams params, DLManagedTensor* dataset_tensor)
{
  auto dataset = dataset_tensor->dl_tensor;

  auto res_ptr = reinterpret_cast<raft::resources*>(res);
  auto index   = new cuvs::neighbors::my_anns_v1::index<T, uint32_t>(*res_ptr);

  auto index_params   = cuvs::neighbors::my_anns_v1::index_params();
  ...
  switch (params.build_algo) {
    case MyAnnsV1GraphBuildAlgo::AUTO_SELECT: break;
    case MyAnnsV1GraphBuildAlgo::IVF_PQ: {
      auto dataset_extent = raft::matrix_extent<int64_t>(dataset.shape[0], dataset.shape[1]);
      index_params.graph_build_params =
        cuvs::neighbors::my_anns_v1::graph_build_params::ivf_pq_params(dataset_extent);
      break;
    }
    case MyAnnsV1GraphBuildAlgo::NN_DESCENT: {
      cuvs::neighbors::my_anns_v1::graph_build_params::nn_descent_params nn_descent_params{};
      nn_descent_params =
    ...
    case MyAnnsV1GraphBuildAlgo::ITERATIVE_my_anns_v1_SEARCH: {
      cuvs::neighbors::my_anns_v1::graph_build_params::iterative_search_params p;
  ...
  if (cuvs::core::is_dlpack_device_compatible(dataset)) {
    ...
    *index            = cuvs::neighbors::my_anns_v1::build(*res_ptr, index_params, mds);
...
void _extend(cuvsResources_t res,
             cuvsmy_anns_v1ExtendParams params,
             cuvsmy_anns_v1Index index,
             ...
             DLManagedTensor* return_tensor)
{
  ...
  auto index_ptr        = reinterpret_cast<cuvs::neighbors::my_anns_v1::index<T, uint32_t>*>(index.addr);
  auto res_ptr          = reinterpret_cast<raft::resources*>(res);

  // TODO: use C struct here (see issue #487)
  auto extend_params           = cuvs::neighbors::my_anns_v1::extend_params();
  ...
  if (cuvs::core::is_dlpack_device_compatible(dataset) &&
    ...
    cuvs::neighbors::my_anns_v1::extend(*res_ptr, extend_params, mds, *index_ptr, return_mds);
  } else if (cuvs::core::is_dlpack_host_compatible(dataset) &&
...
void _search(cuvsResources_t res,
             cuvsmy_anns_v1SearchParams params,
             cuvsmy_anns_v1Index index,
             ...
             cuvsFilter filter)
{
  ...
  auto search_params              = cuvs::neighbors::my_anns_v1::search_params();
  ...
  search_params.algo              = static_cast<cuvs::neighbors::my_anns_v1::search_algo>(params.algo);
  ...
  search_params.hashmap_mode = static_cast<cuvs::neighbors::my_anns_v1::hash_mode>(params.hashmap_mode);
  ...
  if (filter.type == NO_FILTER) {
    ...
    cuvs::neighbors::my_anns_v1::search(*res_ptr,
                                   search_params,
                                   *index_ptr,
                                   queries_mds,
                                   neighbors_mds,
                ...
                bool include_dataset)
{
  auto res_ptr   = reinterpret_cast<raft::resources*>(res);
  auto index_ptr = reinterpret_cast<cuvs::neighbors::my_anns_v1::index<T, uint32_t>*>(index->addr);
  cuvs::neighbors::my_anns_v1::serialize(*res_ptr, std::string(filename), *index_ptr, include_dataset);
}

template <typename T>
void _serialize_to_hnswlib(cuvsResources_t res, const char* filename, cuvsmy_anns_v1Index_t index)
{
  auto res_ptr   = reinterpret_cast<raft::resources*>(res);
  auto index_ptr = reinterpret_cast<cuvs::neighbors::my_anns_v1::index<T, uint32_t>*>(index->addr);
  cuvs::neighbors::my_anns_v1::serialize_to_hnswlib(*res_ptr, std::string(filename), *index_ptr);
}
...
void* _deserialize(cuvsResources_t res, const char* filename)
{
  auto res_ptr = reinterpret_cast<raft::resources*>(res);
  auto index   = new cuvs::neighbors::my_anns_v1::index<T, uint32_t>(*res_ptr);
  cuvs::neighbors::my_anns_v1::deserialize(*res_ptr, std::string(filename), index);
  return index;
}

}  // namespace

extern "C" cuvsError_t cuvsmy_anns_v1IndexCreate(cuvsmy_anns_v1Index_t* index)
{
  return cuvs::core::translate_exceptions([=] { *index = new cuvsmy_anns_v1Index{}; });
}

extern "C" cuvsError_t cuvsmy_anns_v1IndexDestroy(cuvsmy_anns_v1Index_t index_c_ptr)
{
  return cuvs::core::translate_exceptions([=] {
    ...
    if (index.dtype.code == kDLFloat) {
      auto index_ptr =
        reinterpret_cast<cuvs::neighbors::my_anns_v1::index<float, uint32_t>*>(index.addr);
      delete index_ptr;
    } else if (index.dtype.code == kDLInt) {
      auto index_ptr =
        reinterpret_cast<cuvs::neighbors::my_anns_v1::index<int8_t, uint32_t>*>(index.addr);
      delete index_ptr;
    } else if (index.dtype.code == kDLUInt) {
      auto index_ptr =
        reinterpret_cast<cuvs::neighbors::my_anns_v1::index<uint8_t, uint32_t>*>(index.addr);
      delete index_ptr;
    }
    delete index_c_ptr;
  });
...
extern "C" cuvsError_t cuvsmy_anns_v1IndexGetDims(cuvsmy_anns_v1Index_t index, int* dim)
{
  return cuvs::core::translate_exceptions([=] {
    auto index_ptr = reinterpret_cast<cuvs::neighbors::my_anns_v1::index<float, uint32_t>*>(index->addr);
    *dim           = index_ptr->dim();
  });
}

extern "C" cuvsError_t cuvsmy_anns_v1Build(cuvsResources_t res,
...
extern "C" cuvsError_t cuvsmy_anns_v1Extend(cuvsResources_t res,
                                       cuvsmy_anns_v1ExtendParams_t params,
                                       DLManagedTensor* additional_dataset_tensor,
                                       cuvsmy_anns_v1Index_t index_c_ptr,
...
extern "C" cuvsError_t cuvsmy_anns_v1Search(cuvsResources_t res,
...
extern "C" cuvsError_t cuvsmy_anns_v1IndexParamsCreate(cuvsmy_anns_v1IndexParams_t* params)
{
  return cuvs::core::translate_exceptions([=] {
    *params = new cuvsmy_anns_v1IndexParams{.metric                    = L2Expanded,
...
extern "C" cuvsError_t cuvsmy_anns_v1IndexParamsDestroy(cuvsmy_anns_v1IndexParams_t params)
{
  return cuvs::core::translate_exceptions([=] { delete params; });
}

extern "C" cuvsError_t cuvsmy_anns_v1CompressionParamsCreate(cuvsmy_anns_v1CompressionParams_t* params)
{
  return cuvs::core::translate_exceptions([=] {
    auto ps = cuvs::neighbors::vpq_params();
    *params =
      new cuvsmy_anns_v1CompressionParams{.pq_bits                     = ps.pq_bits,
                                     .pq_dim                      = ps.pq_dim,
...
extern "C" cuvsError_t cuvsmy_anns_v1CompressionParamsDestroy(cuvsmy_anns_v1CompressionParams_t params)
{
  return cuvs::core::translate_exceptions([=] { delete params; });
}

extern "C" cuvsError_t cuvsmy_anns_v1ExtendParamsCreate(cuvsmy_anns_v1ExtendParams_t* params)
{
  return cuvs::core::translate_exceptions(
    [=] { *params = new cuvsmy_anns_v1ExtendParams{.max_chunk_size = 0}; });
}

extern "C" cuvsError_t cuvsmy_anns_v1ExtendParamsDestroy(cuvsmy_anns_v1ExtendParams_t params)
{
  return cuvs::core::translate_exceptions([=] { delete params; });
}

extern "C" cuvsError_t cuvsmy_anns_v1SearchParamsCreate(cuvsmy_anns_v1SearchParams_t* params)
{
  return cuvs::core::translate_exceptions([=] {
    *params = new cuvsmy_anns_v1SearchParams{.itopk_size            = 64,
                                        .search_width          = 1,
...
extern "C" cuvsError_t cuvsmy_anns_v1SearchParamsDestroy(cuvsmy_anns_v1SearchParams_t params)
{
  return cuvs::core::translate_exceptions([=] { delete params; });
}

extern "C" cuvsError_t cuvsmy_anns_v1Deserialize(cuvsResources_t res,
                                            const char* filename,
                                            cuvsmy_anns_v1Index_t index)
{
  return cuvs::core::translate_exceptions([=] {
...
extern "C" cuvsError_t cuvsmy_anns_v1Serialize(cuvsResources_t res,
                                          const char* filename,
                                          cuvsmy_anns_v1Index_t index,
                                          bool include_dataset)
{
...
extern "C" cuvsError_t cuvsmy_anns_v1SerializeToHnswlib(cuvsResources_t res,
                                                   const char* filename,
                                                   cuvsmy_anns_v1Index_t index)
{
  return cuvs::core::translate_exceptions([=] {
