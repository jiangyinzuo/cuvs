...
namespace cuvs::neighbors::my_anns_v1::detail::graph {
  ...
  const bool guarantee_connectivity = true)
{
  ...
  raft::common::nvtx::range<cuvs::common::nvtx::domain::cuvs> fun_scope(
    "my_anns_v1::graph::optimize(%zu, %zu, %u)", graph_size, input_graph_degree, output_graph_degree);
...
#pragma omp parallel for
  ...
  if (guarantee_connectivity) {
    raft::common::nvtx::range<cuvs::common::nvtx::domain::cuvs> block_scope(
      "my_anns_v1::graph::optimize/check_connectivity");
    mst_graph =
  ...
  {
    raft::common::nvtx::range<cuvs::common::nvtx::domain::cuvs> block_scope(
      "my_anns_v1::graph::optimize/prune");
    //
    // Prune kNN graph
    //
...
#pragma omp parallel for
    ...
    RAFT_EXPECTS(
      ...
      "Could not generate an intermediate my_anns_v1 graph because the initial kNN graph contains too "
  ...
  {
    raft::common::nvtx::range<cuvs::common::nvtx::domain::cuvs> block_scope(
      "my_anns_v1::graph::optimize/reverse");
    //
    // Make reverse graph
    //
...
#pragma omp parallel for
  ...
  {
    raft::common::nvtx::range<cuvs::common::nvtx::domain::cuvs> block_scope(
      "my_anns_v1::graph::optimize/combine");
    //
...
#pragma omp parallel for reduction(+ : num_replaced_edges)
  ...
  {
    raft::common::nvtx::range<cuvs::common::nvtx::domain::cuvs> block_scope(
      "my_anns_v1::graph::optimize/check_edges");
...
#pragma omp atomic
  ...
  {
    raft::common::nvtx::range<cuvs::common::nvtx::domain::cuvs> block_scope(
      "my_anns_v1::graph::optimize/check_duplicates");
    uint64_t num_dup = 0;
    uint64_t num_oor = 0;
#pragma omp parallel for reduction(+ : num_dup) reduction(+ : num_oor)
    ...
    RAFT_EXPECTS(
      num_dup == 0, "%lu duplicated node(s) are found in the generated my_anns_v1 graph", num_dup);
    RAFT_EXPECTS(num_oor == 0,
                 "%lu out-of-range index node(s) are found in the generated my_anns_v1 graph",
                 num_oor);
  }
}
