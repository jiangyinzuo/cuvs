    ...
    for (mxdim, team) in mxdim_team:
        ...
        for metric in ['L2Expanded', 'InnerProduct']:
            ...
            with open(path, "w") as f:
                ...
                cmake_list.append(f"  src/neighbors/detail/my_anns_v1/{path}")
...
# my_anns_v1 (Binary Hamming distance)
for (mxdim, team) in mxdim_team:
...
auto dataset_descriptor_init(const my_anns_v1::search_params& params,
