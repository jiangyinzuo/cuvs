...
namespace cuvs::neighbors::experimental::hnsw_gpu {
/**
...
void search(raft::resources const& res,
            hnsw_gpu::search_params const& params,
            const hnsw_gpu::index<float, uint32_t>& index,
...
void search(raft::resources const& res,
            hnsw_gpu::search_params const& params,
            const hnsw_gpu::index<half, uint32_t>& index,
...
void search(raft::resources const& res,
            hnsw_gpu::search_params const& params,
            const hnsw_gpu::index<int8_t, uint32_t>& index,
...
void search(raft::resources const& res,
            hnsw_gpu::search_params const& params,
            const hnsw_gpu::index<uint8_t, uint32_t>& index,
